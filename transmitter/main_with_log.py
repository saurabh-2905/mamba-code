...
### sample logging statement: vl.log(var='0', fun='0', clas='0', th='0', val=None)
...
def measure_scd30():
    ...
    Takes CO2 reading.
    """
    vl.log(var='0', fun='measure_scd30', clas='0', th='0', val=None)
...
def measure_co():
    ...
    Takes CO reading.
    """
    vl.log(var='0', fun='measure_co', clas='0', th='0', val=None)
...
def measure_o2():
    ...
    Takes O2 reading.
    """
    vl.log(var='0', fun='measure_o2', clas='0', th='0', val=None)
...
def measure_bmp():
    ...
    """
    vl.log(var='0', fun='measure_bmp', clas='0', th='0', val=None)
...
def measure_am1(stat):
    ...
    try:
        ...
        vl.log(var='am_temp', fun='measure_am1', clas='0', th='0', val=am_temp)    ### logging
        vl.log(var='am_hum', fun='measure_am1', clas='0', th='0', val=am_hum)    ### logging
    except Exception:
        CONNECTION_VAR[stat] = 0
        vl.log(var='CONNECTION_VAR', fun='measure_am1', clas='0', th='0', val=CONNECTION_VAR[stat])    ### logging
...
def measure_am2(stat):
    ...
    try:
        ...
        vl.log(var='am_temp', fun='measure_am2', clas='0', th='0', val=am_temp)    ### logging
        vl.log(var='am_hum', fun='measure_am2', clas='0', th='0', val=am_hum)    ### logging

    except Exception:
        CONNECTION_VAR[stat] = 0
        vl.log(var='CONNECTION_VAR', fun='measure_am2', clas='0', th='0', val=CONNECTION_VAR[stat])    ### logging
...
def measure_am3(stat):
    ...
    try:
        ...
        vl.log(var='am_temp', fun='measure_am3', clas='0', th='0', val=am_temp)    ### logging
        vl.log(var='am_hum', fun='measure_am3', clas='0', th='0', val=am_hum)    ### logging
    except Exception:
        CONNECTION_VAR[stat] = 0
        vl.log(var='CONNECTION_VAR', fun='measure_am3', clas='0', th='0', val=CONNECTION_VAR[stat])    ### logging
...
def measure_am4(stat):
    ...
    try:
        ...
        vl.log(var='am_temp', fun='measure_am4', clas='0', th='0', val=am_temp)    ### logging
        vl.log(var='am_hum', fun='measure_am4', clas='0', th='0', val=am_hum)    ### logging
    except Exception:
        CONNECTION_VAR[stat] = 0
        vl.log(var='CONNECTION_VAR', fun='measure_am4', clas='0', th='0', val=CONNECTION_VAR[stat])    ### logging
...
def cb_30(p):
    ...
    global cb_30_done
    cb_30_done = True
    vl.log(var='cb_30_done', fun='cb_30', clas='0', th='0', val=cb_30_done)    ### logging
...
def cb_retrans(p):
    ...
    vl.log(var='cb_retrans_done', fun='cb_retrans', clas='0', th='0', val=cb_retrans_done)    ### logging
...
def lora_scheduled(r_msg):
    ...
    cb_lora_recv = True
    vl.log(var='cb_lora_recv', fun='lora_scheduled', clas='0', th='0', val=cb_lora_recv)    ### logging
    rcv_msg.append(r_msg)
    vl.log(var='rcv_msg', fun='lora_scheduled', clas='0', th='0', val=r_msg)    ### logging
...
def cb_lora(p):
    ...
    vl.log(var='0', fun='cb_lora', clas='0', th='0', val=None)    ### logging
...
def crc32(crc, p, len):
    ...
    """
    crc = 0xffffffff & ~crc
    vl.log(var='crc', fun='crc32', clas='0', th='0', val=crc)    ### logging
    for i in range(len):
        crc = crc ^ p[i]
        vl.log(var='crc', fun='crc32', clas='0', th='0', val=crc)    ### logging
        for j in range(8):
...
def write_to_log(msg, timestamp):
    ...
    """
    vl.log(var='0', fun='write_to_log', clas='0', th='0', val=None)    ### logging
...
def add_to_que(msg, current_time):
    ...
    if len(que) >= MAX_QUEUE:
        ...
        vl.log(var='que', fun='add_to_que', clas='0', th='0', val=(msg, current_time))    ### logging
...
def get_nodename():
    ...
    vl.log(var='uuid', fun='get_nodename', clas='0', th='0', val=uuid)    ### logging
    node_name = "ESP_" + uuid
    vl.log(var='node_name', fun='get_nodename', clas='0', th='0', val=node_name)    ### logging
    return node_name
...
def get_node_id(hex=False):
    ...
    vl.log(var='node_id', fun='get_node_id', clas='0', th='0', val=node_id)    ### logging
...
def lora_rcv_exec(p):
    ...
    if cb_lora_recv:
        cb_lora_recv = False
        vl.log(var='cb_lora_recv', fun='lora_rcv_exec', clas='0', th='0', val=cb_lora_recv)    ### logging
        for i in range(len(rcv_msg)):
            msg = rcv_msg[i]
            vl.log(var='msg', fun='lora_rcv_exec', clas='0', th='0', val=msg)
            try:
                recv_msg = msg.decode()
                vl.log(var='recv_msg', fun='lora_rcv_exec', clas='0', th='0', val=recv_msg)
                print('received msg', recv_msg)
                board_id, timestamp = recv_msg.split(',')
                vl.log(var='board_id', fun='lora_rcv_exec', clas='0', th='0', val=board_id)
                vl.log(var='timestamp', fun='lora_rcv_exec', clas='0', th='0', val=timestamp)
        ...
        rcv_msg = []
        vl.log(var='rcv_msg', fun='lora_rcv_exec', clas='0', th='0', val=rcv_msg)    ### logging
...
# packing format
_pkng_frmt = '>12f3HI'
vl.log(var='_pkng_frmt', fun='0', clas='0', th='0', val=_pkng_frmt)    ### logging

SENSORBOARD_ID = get_node_id()
vl.log(var='SENSORBOARD_ID', fun='0', clas='0', th='0', val=SENSORBOARD_ID)    ### logging


# ------------------------ constants and variables ----------------------------
# addresses of sensors
O2_ADRR = const(0x48)
vl.log(var='O2_ADRR', fun='0', clas='0', th='0', val=O2_ADRR)    ### logging
CO_ADRR = const(0x49)
vl.log(var='CO_ADRR', fun='0', clas='0', th='0', val=CO_ADRR)    ### logging
SCD30_ADRR = const(0x61)
vl.log(var='SCD30_ADRR', fun='0', clas='0', th='0', val=SCD30_ADRR)    ### logging
AM2301_1_ADRR = const(0)
vl.log(var='AM2301_1_ADRR', fun='0', clas='0', th='0', val=AM2301_1_ADRR)    ### logging
AM2301_2_ADRR = const(4)
vl.log(var='AM2301_2_ADRR', fun='0', clas='0', th='0', val=AM2301_2_ADRR)    ### logging
AM2301_3_ADRR = const(17)
vl.log(var='AM2301_3_ADRR', fun='0', clas='0', th='0', val=AM2301_3_ADRR)    ### logging
AM2301_4_ADRR = const(16)
vl.log(var='AM2301_4_ADRR', fun='0', clas='0', th='0', val=AM2301_4_ADRR)    ### logging

# connection_variables init for sensors
FAILED_LORA = 1
vl.log(var='FAILED_LORA', fun='0', clas='0', th='0', val=FAILED_LORA)    ### logging
CONNECTION_CO2 = 1
vl.log(var='CONNECTION_CO2', fun='0', clas='0', th='0', val=CONNECTION_CO2)    ### logging
CONNECTION_CO = 1
vl.log(var='CONNECTION_CO', fun='0', clas='0', th='0', val=CONNECTION_CO)    ### logging
CONNECTION_O2 = 1
vl.log(var='CONNECTION_O2', fun='0', clas='0', th='0', val=CONNECTION_O2)    ### logging
CONNECTION_BMP = 1
vl.log(var='CONNECTION_BMP', fun='0', clas='0', th='0', val=CONNECTION_BMP)    ### logging
CONNECTION_A1 = 1
vl.log(var='CONNECTION_A1', fun='0', clas='0', th='0', val=CONNECTION_A1)    ### logging
CONNECTION_A2 = 1
vl.log(var='CONNECTION_A2', fun='0', clas='0', th='0', val=CONNECTION_A2)    ### logging
CONNECTION_A3 = 1
vl.log(var='CONNECTION_A3', fun='0', clas='0', th='0', val=CONNECTION_A3)    ### logging
CONNECTION_A4 = 1
vl.log(var='CONNECTION_A4', fun='0', clas='0', th='0', val=CONNECTION_A4)    ### logging
MAX_QUEUE = const(10)
vl.log(var='MAX_QUEUE', fun='0', clas='0', th='0', val=MAX_QUEUE)    ### logging
scd_co2 = 0
vl.log(var='scd_co2', fun='0', clas='0', th='0', val=scd_co2)    ### logging
scd_temp = 0
vl.log(var='scd_temp', fun='0', clas='0', th='0', val=scd_temp)    ### logging
scd_hum = 0
vl.log(var='scd_hum', fun='0', clas='0', th='0', val=scd_hum)    ### logging
am_temp = 0
vl.log(var='am_temp', fun='0', clas='0', th='0', val=am_temp)    ### logging
am_hum = 0
vl.log(var='am_hum', fun='0', clas='0', th='0', val=am_hum)    ### logging

# list for measurements values
que = []
vl.log(var='que', fun='0', clas='0', th='0', val=None)    ### logging

# init cb booleans
cb_30_done = False
vl.log(var='cb_30_done', fun='0', clas='0', th='0', val=cb_30_done)    ### logging
cb_retrans_done = False
vl.log(var='cb_retrans_done', fun='0', clas='0', th='0', val=cb_retrans_done)    ### logging
cb_lora_recv = False
vl.log(var='cb_lora_recv', fun='0', clas='0', th='0', val=cb_lora_recv)    ### logging

# init msg intervals
msg_interval = 30000  # 30 sec
vl.log(var='msg_interval', fun='0', clas='0', th='0', val=msg_interval)    ### logging
retx_interval = 5000  # 5 sec
vl.log(var='retx_interval', fun='0', clas='0', th='0', val=retx_interval)    ### logging

# ------------------------ establish connections ------------------------------
# establish I2c Bus
try:
    I2CBUS = I2C(1, sda=Pin(21), scl=Pin(22), freq=100000)
    vl.log(var='I2CBUS', fun='0', clas='0', th='0', val=I2CBUS)    ### logging
except Exception:
...
try:
    ...
    vl.log(var='SPI_BUS', fun='0', clas='0', th='0', val=SPI_BUS)    ### logging
    lora = LoRa(SPI_BUS, True, cs=Pin(5, Pin.OUT), rx=Pin(2, Pin.IN))
    vl.log(var='lora', fun='0', clas='0', th='0', val=lora)    ### logging
except Exception:
    FAILED_LORA = 0
    vl.log(var='FAILED_LORA', fun='0', clas='0', th='0', val=FAILED_LORA)    ### logging
...
try:
    ...
    vl.log(var='scd30', fun='0', clas='0', th='0', val=scd30)    ### logging
...
try:
    ...
    vl.log(var='MCP_CO', fun='0', clas='0', th='0', val=MCP_CO)    ### logging
except Exception:
    CONNECTION_CO = 0
    vl.log(var='CONNECTION_CO', fun='0', clas='0', th='0', val=CONNECTION_CO)    ### logging
...
try:
    ...
    vl.log(var='MCP_O2', fun='0', clas='0', th='0', val=MCP_O2)    ### logging
except Exception:
    CONNECTION_O2 = 0
    vl.log(var='CONNECTION_O2', fun='0', clas='0', th='0', val=CONNECTION_O2)    ### logging
...
try:
    BMP = BMP180(I2CBUS)
    vl.log(var='BMP', fun='0', clas='0', th='0', val=BMP)    ### logging
except Exception:
    CONNECTION_BMP = 0
    vl.log(var='CONNECTION_BMP', fun='0', clas='0', th='0', val=CONNECTION_BMP)    ### logging
...
try:
    ...
    vl.log(var='AM2301_1', fun='0', clas='0', th='0', val=AM2301_1)    ### logging
except Exception:
    CONNECTION_A1 = 0
    vl.log(var='CONNECTION_A1', fun='0', clas='0', th='0', val=CONNECTION_A1)    ### logging
...
try:
    ...
    vl.log(var='AM2301_2', fun='0', clas='0', th='0', val=AM2301_2)    ### logging
except Exception:
    CONNECTION_A2 = 0
    vl.log(var='CONNECTION_A2', fun='0', clas='0', th='0', val=CONNECTION_A2)    ### logging
...
try:
    ...
    vl.log(var='AM2301_3', fun='0', clas='0', th='0', val=AM2301_3)    ### logging
except Exception:
    CONNECTION_A3 = 0
    vl.log(var='CONNECTION_A3', fun='0', clas='0', th='0', val=CONNECTION_A3)    ### logging
...
try:
    ...
    vl.log(var='AM2301_4', fun='0', clas='0', th='0', val=AM2301_4)    ### logging
except Exception:
    CONNECTION_A4 = 0
    vl.log(var='CONNECTION_A4', fun='0', clas='0', th='0', val=CONNECTION_A4)    ### logging
...
THRESHOLD_LIMITS = ((0.0, 3000.0), (0.0, 20.0), (0, 23.0), (950.0, 1040.0),
                    (18.0, 30.0, 0.0, 100.0))
vl.log(var='THRESHOLD_LIMITS', fun='0', clas='0', th='0', val=THRESHOLD_LIMITS)    ### logging
...
vl.log(var='CONNECTION_VAR', fun='0', clas='0', th='0', val=CONNECTION_VAR)    ### logging

SENSORS_LIST = ['CO2', 'CO', 'O2', 'BMP', 'AM1', 'AM2', 'AM3', 'AM4']
vl.log(var='SENSORS_LIST', fun='0', clas='0', th='0', val=SENSORS_LIST)    ### logging
...
vl.log(var='FUNC_VAR', fun='0', clas='0', th='0', val=FUNC_VAR)    ### logging

# Create Timers
timer0 = Timer(0)
vl.log(var='timer0', fun='0', clas='0', th='0', val=None)    ### logging
timer1 = Timer(1)
vl.log(var='timer1', fun='0', clas='0', th='0', val=None)    ### logging
...
vl.log(var='SENSOR_DATA', fun='0', clas='0', th='0', val=SENSOR_DATA)    ### logging

# ------------------------ infinite loop execution ----------------------------
msg = ""  # msg init
vl.log(var='msg', fun='0', clas='0', th='0', val=msg)    ### logging
rcv_msg = []  # rcv_msg init
vl.log(var='rcv_msg', fun='0', clas='0', th='0', val=None)    ### logging
...
vl.log(var='start_time', fun='0', clas='0', th='0', val=start_time)    ### logging
retransmit_count = 0
vl.log(var='retransmit_count', fun='0', clas='0', th='0', val=retransmit_count)    ### logging

while True:
    # get the current time of the script in seconds wrt the localtime
    current_time = time.mktime(time.localtime())
    vl.log(var='current_time', fun='0', clas='0', th='0', val=current_time)    ### logging
    SENSOR_STATUS = 0
    vl.log(var='SENSOR_STATUS', fun='0', clas='0', th='0', val=SENSOR_STATUS)    ### logging
    LIMITS_BROKEN = 0
    vl.log(var='LIMITS_BROKEN', fun='0', clas='0', th='0', val=LIMITS_BROKEN)    ### logging
    print('start of the loop:', current_time, SENSOR_STATUS, LIMITS_BROKEN)
    j = 6
    vl.log(var='j', fun='0', clas='0', th='0', val=j)    ### logging
    for i in range(len(CONNECTION_VAR)):
        # Sensor Data is available & sensor is working
        func_call = FUNC_VAR[i]
        vl.log(var='func_call', fun='0', clas='0', th='0', val=func_call)    ### logging
        try:
            if i == 0:
                # SCD30 sensor readings (involves three values)
                reading_co2 = func_call()
                vl.log(var='reading_co2', fun='0', clas='0', th='0', val=reading_co2)    ### logging
                ...
                var = func_call()
                vl.log(var='var', fun='0', clas='0', th='0', val=var)    ### logging
                if not (THRESHOLD_LIMITS[i][0] <= var <= THRESHOLD_LIMITS[i][1]):
                    print('Thresh broken', i, var)
                    LIMITS_BROKEN = 1
                    vl.log(var='LIMITS_BROKEN', fun='0', clas='0', th='0', val=LIMITS_BROKEN)    ### logging
                SENSOR_DATA[i+2] = round(var, 2)
                vl.log(var='SENSOR_DATA', fun='0', clas='0', th='0', val=SENSOR_DATA)
            else:
        ...
        if not CONNECTION_VAR[i]:
            ...
            if i == 0:
                ...
                SENSOR_STATUS += 2**(i)
                vl.log(var='SENSOR_STATUS', fun='0', clas='0', th='0', val=SENSOR_STATUS)
            else:
                SENSOR_STATUS += 2**(i)
                vl.log(var='SENSOR_STATUS', fun='0', clas='0', th='0', val=SENSOR_STATUS)
    ...
    if LIMITS_BROKEN:
        ...
        if random.random() >= 0.4:
            ...
            vl.log(var='retx_interval', fun='0', clas='0', th='0', val=retx_interval)

        # reset timer booleans
        cb_30_done = False
        vl.log(var='cb_30_done', fun='0', clas='0', th='0', val=cb_30_done)
    elif cb_retrans_done:  # retransmit every 5 seconds for piled up packets with no ack
        cb_retrans_done = False
        vl.log(var='cb_retrans_done', fun='0', clas='0', th='0', val=cb_retrans_done)
        retransmit_count += 1
        vl.log(var='retransmit_count', fun='0', clas='0', th='0', val=retransmit_count)
        if que != []:
            lora.send(que[0][0])
