...
am_available1 = False
vl.log(var='am_available1', fun=_fun_name, clas=_cls_name, th=_thread_id)
am_available2 = False
vl.log(var='am_available2', fun=_fun_name, clas=_cls_name, th=_thread_id)
am_available3 = False
vl.log(var='am_available3', fun=_fun_name, clas=_cls_name, th=_thread_id)
am_available4 = False
vl.log(var='am_available4', fun=_fun_name, clas=_cls_name, th=_thread_id)
am_availability = [am_available1, am_available2, am_available3, am_available4]
vl.log(var='am_availability', fun=_fun_name, clas=_cls_name, th=_thread_id)
